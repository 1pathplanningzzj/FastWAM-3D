...
OUT_DIR="/data/zijianzhang/FastWAM/evaluate_results/robotwin/robotwin_gaussianwam_stage2_focus3_fullft_current_3cam_384_1e-4_2026-06-08_20-11-33_gpus3-4-5-7_tmux/20260610_3tasks_step25000_gpu6"
CKPT="/data/zijianzhang/FastWAM/runs/robotwin_gaussianwam_stage2_focus3_fullft_current_3cam_384_1e-4/2026-06-08_20-11-33_gpus3-4-5-7_tmux/checkpoints/weights/step_025000.pt"
...
LOG="$OUT_DIR/launch_step25000_gpu6.log"

mkdir -p "$OUT_DIR"

printf '[%s] start step_025000 eval on gpu=6\n' "$(date '+%F %T')" >> "$LOG"
...
printf '[%s] finished step_025000 eval on gpu=6\n' "$(date '+%F %T')" >> "$LOG"
