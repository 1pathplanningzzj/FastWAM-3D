...
CKPT="${RUNS_ROOT}/${RUN_NAME}/${RUN_ID}/checkpoints/weights/step_002000.pt"
STATS="${RUNS_ROOT}/${RUN_NAME}/${RUN_ID}/dataset_stats.json"
OUT_DIR="/data/zijianzhang/FastWAM/evaluate_results/robotwin/${RUN_NAME}_${RUN_ID}/20260713_full_step002000_gpus1-2-3-4"
