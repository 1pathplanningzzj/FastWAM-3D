...
RUN_ID="2026-07-16_fastwam_uncond_clean15table_first50_cleanstats_gpus0-5-6-7_globalbs64_gradacc2_save3k_max20k"
export RUN_ID

LOG="${GAUSSIANWAM_ROOT}/runs/robotwin_fastwam_uncond_clean15table_stats20k_gradacc2_gpus0_5_6_7_20260716.log"
